...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C009%20rows-8250df">
...
**Public extract:** 7,009 rows · **Live catalog:** 7,008 domains
...
- `digital.csv` — public CSV extract (7,009 rows)
- `digital.json` — public JSON extract (7,009 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,009-row public sample | 7,008 live domains                               |
...
> Unique Domains. *Available .DIGITAL One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
