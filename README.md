# Available .DIGITAL One-Word Domains (9,568)
...
> The full live catalog for this exact search currently contains **9,568 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 9,568 domains · **Median ask:** $8.29 · **High-demand under $2,500:** 0
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,568 live domains                         |
...
> Unique Domains. *Available .DIGITAL One-Word Domains*. Version 2026-05-17. Public GitHub extract for the exact Unique Domains search represented by this repository.
